/**
 * Admin configuration loading and validation (Ergo)
 *
 * Loads HMAC shared key for transaction-based command authentication.
 * Validates wallet addresses as Base58 Ergo format.
 */
...
export function loadAdminConfig(): AdminConfig | null {
  try {
    ...
    // Validate wallet address format (Ergo Base58)
